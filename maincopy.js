(function() {
    ...
    //global variables
    let monthCheck = document.querySelector("#period1");
    let yearCheck = document.querySelector("#period2");
    let yesNSSF = document.querySelector("#deductNssf1");
    let noNSSF = document.querySelector("#deductNssf2");
    let yesNHIF = document.querySelector("#deductNHIF1");
    let noNHIF = document.querySelector("#deductNHIF2");
    let newRates = document.querySelector("#nnr1");
    let oldRates = document.querySelector("#nnr2")
    let benefitsInput = document.querySelector("#beneFiti");
    let salaryInput = document.querySelector("#basicsSl");
